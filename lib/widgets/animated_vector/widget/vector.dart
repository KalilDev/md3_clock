...
class _MergedStyleMapping extends StyleMapping {
...
class ColorSchemeStyleMapping extends StyleMapping {
...
class _EmptyStyleMapping extends StyleMapping {
...
class _MapStyleMapping extends StyleMapping {
  ...
  */
  ...
  static ui.Path _uiPathForPath(Path path) {
    ...
    for (final segment in path.pathData.segments) {
      normalizer.emitSegment(segment, creator);
    }
    return creator.path;
  }
