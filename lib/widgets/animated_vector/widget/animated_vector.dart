...
class ObjectAnimator extends Animator {
...
abstract class AnimatorSet extends Animator {
...
PathSegmentData lerpPathSegment(
  ...
  double t,
    ...
    // We cannot split the lerping of _PathOffset to another function, so we do
    // inline
    PathSegmentData()
...
class AnimatedVectorWidget extends StatefulWidget {
  ...
  @override
  _AnimatedVectorWidgetState createState() => _AnimatedVectorWidgetState();
}
...
class _AnimatedVectorWidgetState extends State<AnimatedVectorWidget>
  ...
  Map<String, Object> _propertiesFromNode(
    ...
    return animators.fold({}, (acc, e) => acc..addAll(e.values(styleMapping)));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return root.changes.map((_) => _buildVector(styleMapping)).build(
