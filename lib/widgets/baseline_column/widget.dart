...
import 'package:md3_clock/widgets/baseline_column/render.dart';

class BaselineColumn extends MultiChildRenderObjectWidget {
  /// Creates a BaselineColumn layout.
  ///
  /// The [crossAxisAlignment], [textBaseline], and
  ...
  BaselineColumn({
    ...
    required this.textBaseline, // NO DEFAULT: we don't know what the text's baseline should be
  ...
  /// The value to pass to [RenderBaselineColumn.textDirection].
  ///
  ...
  /// except for vertical BaselineColumnes (e.g. [Column]s) whose [crossAxisAlignment] is
  ...
  ///
  /// This method exists so that subclasses of [BaselineColumn] that create their own
  /// render objects that are derived from [RenderBaselineColumn] can do so and still use
  ...
  @override
  RenderBaselineColumn createRenderObject(BuildContext context) {
    return RenderBaselineColumn(
  ...
  void updateRenderObject(
      BuildContext context, RenderBaselineColumn renderObject) {
    renderObject
      ..crossAxisAlignment = crossAxisAlignment
      ..textDirection = getEffectiveTextDirection(context)
      ..verticalDirection = verticalDirection
